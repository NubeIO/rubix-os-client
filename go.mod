module github.com/NubeIO/rubix-os-client
...
require (
	...
	github.com/NubeIO/nubeio-rubix-lib-models-go v1.10.1
	github.com/NubeIO/rubix-os v0.2.0
	github.com/NubeIO/rubix-ui v0.2.0
...
require (
	...
	github.com/wailsapp/wails/v2 v2.6.0 // indirect
